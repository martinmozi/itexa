...
Rozdelenie podľa lekcií (kedy sa čo preberá) je v [prehlad-predmetu.md](../prehlad-predmetu.md).
...
## Celé poradie čítania

1. [Vývojové prostredie](00-prostredie/01-vyvojove-prostredie.md)
2. [Čo je umelá inteligencia](01-prehlad/01-co-je-ai.md)
3. [Režimy strojového učenia](01-prehlad/02-rezimy-strojoveho-ucenia.md)
4. [Zovšeobecnenie a preučenie](01-prehlad/03-generalizacia-a-preucenie.md)
5. [Metriky](01-prehlad/04-metriky.md)
6. [Rozhodovacie stromy](02-typy-modelov/01-rozhodovacie-stromy.md)
7. [Random Forest a XGBoost](02-typy-modelov/02-random-forest-a-xgboost.md)
8. [XGBoost krok za krokom — ISO 8583](02-typy-modelov/03-xgboost-priklad-iso8583.md)
9. [Feed-forward siete (MLP)](02-typy-modelov/04-feed-forward-siete.md)
10. [Konvolučné siete (CNN)](02-typy-modelov/05-konvolucne-siete.md)
11. [Ktorý model kedy](02-typy-modelov/06-ktory-model-kedy.md)
...
- [Zadanie 1 — rozpoznávanie obrázkov](../zadania/rozpoznavanie-obrazkov.md) (lekcie 3–4)
- [Zadanie 2 — RAG a fine-tuning](../zadania/RAG_Fine_tunning.md) (lekcie 6–7)
