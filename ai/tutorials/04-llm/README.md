...
| [02-transformer-vnutro.md](02-transformer-vnutro.md) | rozmery a parametre, feed-forward token po tokene, vznik výstupného tokenu, KV cache a prečo je kontext obmedzený |
| [03-llm-trening.md](03-llm-trening.md) | dáta → pretraining → base model → SFT/instruction tuning → Instruct model, výhľad na RLHF/DPO |
